    ...
    <div class="row">
        <div class="col">
            ...
            <?php foreach ($apj as $a) : ?>
                <?php if ($a['APJ_ID'] === '1') : ?>
                    <h2><a class="btn btn-primary mt-1" data-bs-toggle="collapse" href="#multiCollapseExample1" role="button" aria-expanded="false" aria-controls="multiCollapseExample1">
                            <?= $a['APJ_NAMA']; ?></a></h2>

                    <!-- Gardu Induk BSB -->

                    <h2><?php foreach ($gi as $g) : ?><?php  ?>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <?php foreach ($gi as $g) : ?>
                                                ...
                                                <h2 class="fs-3"><?= $g['GARDU_INDUK_NAMA']; ?></h2>
                                            <?php endif; ?>
                                        <?php endforeach; ?>
                                        </div>
                                    </div>
        ...
        <?php foreach ($apj as $a) : ?>
            <?php if ($a['APJ_ID'] === '2') : ?>
                ...
                <h1><?php foreach ($gi as $g) : ?><?php  ?>
                    <div class="btn-group-vertical" class="collapse multi-collapse" id="multiCollapseExample1">
                        <?php if ($g['GARDU_INDUK_ID'] === '52') : ?><?php  ?>

                        <div class="card card-body">
                            <h2 class="fs-3">
                                <?= $g['GARDU_INDUK_NAMA']; ?>
                            </h2>
                            <!-- Trafo01_BANYUDONO 125-->
                            <div class="container">
                                <div class="row">
                                    <div class="col">
                                        <?php foreach ($incoming as $i) : ?><?php  ?>
                                        <?php if ($i['INCOMING_ID'] === '125') : ?><?php  ?>
                                        <div class="btn-group-horizontal">
                                            <p class="fs-3"><?= $i['NAMA_ALIAS_INCOMING']; ?></p>
                                        <?php endif; ?>
                                        </div>
                            ...
                            <!-- Trafo02_BANYUDONO 132-->
                            <div class="container">
                                <div class="row">
                                    <div class="col">
                                        <?php foreach ($incoming as $i) : ?><?php  ?>
                                        <?php if ($i['INCOMING_ID'] === '132') : ?><?php  ?>
                                        <div class="btn-group-horizontal">
                                            <p class="fs-3"><?= $i['NAMA_ALIAS_INCOMING']; ?></p>
                                        <?php endif; ?>
                                        </div>
                            ...
                            <!-- Trafo03_BANYUDONOOBILE 157tidak ada data-->



                            <!-- Trafo03_BANYUDONO 168-->
