                                                                    ...
                                                                    <div class="card-body py-0">
                                                                        <table id="" class="table table-bordered">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-2 border border-dark" scope="col" style="text-align:center" data-toggle="tooltip" data-placement="top" title="Beban Trafo DAYA REAKTIF TRAFO"><strong role="" class="" data-incoming="<?php echo $income['INCOMING_ID']; ?>" data-incoming-name="DAYA_REAKTIF_TRAFO"><u>DAYA</u></strong><br> <?php echo $income['DAYA_REAKTIF_TRAFO'] ?? 0 ?> </div>
                                                                            </div>
                                                                        </table>
                                                                    </div>
                                                                </div>
